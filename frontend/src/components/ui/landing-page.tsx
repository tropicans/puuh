...
const navItems = [
  ...
  { label: "Studi Kasus", href: "#use-case" },
...
export function DesignAgency({ isAuthenticated = false }: DesignAgencyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/10 text-foreground">
        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Intelijen Regulasi</p>
            </div>
          </Link>
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-12 md:px-6 md:py-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:py-24">
            ...
            >
              ...
              <div className="absolute bottom-0 p-5 text-white">
                <p className="text-sm font-semibold">Pemantauan Perubahan Regulasi</p>
                <p className="text-xs text-white/80">Unggah, parse, bandingkan, dan review dalam satu alur kerja.</p>
              </div>
            </motion.div>
          </div>
        </section>
      ...
      <div className="border-t bg-background/95 p-3 md:hidden">
        <Button asChild className="w-full">
