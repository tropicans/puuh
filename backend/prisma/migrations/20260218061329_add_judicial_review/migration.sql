...
-- CreateEnum
CREATE TYPE "JudicialForum" AS ENUM ('MK', 'MA');

-- CreateEnum
CREATE TYPE "JudicialOutcome" AS ENUM ('GRANTED', 'PARTIALLY_GRANTED', 'REJECTED', 'INADMISSIBLE', 'WITHDRAWN', 'OTHER');

-- CreateEnum
CREATE TYPE "JudicialDisposition" AS ENUM ('INVALIDATED', 'UPHELD', 'CONDITIONALLY_VALID', 'CONDITIONALLY_INVALID', 'NO_DIRECT_EFFECT');
...
-- CreateTable
CREATE TABLE "JudicialReviewCase" (
    "id" TEXT NOT NULL,
    "regulationId" TEXT NOT NULL,
    "forum" "JudicialForum" NOT NULL,
    "decisionNumber" TEXT NOT NULL,
    "decisionDate" TIMESTAMP(3),
    "petitionSummary" TEXT,
    "amarText" TEXT NOT NULL,
    "sourceUrl" TEXT,
    "rawText" TEXT,
    "outcome" "JudicialOutcome" NOT NULL DEFAULT 'OTHER',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "JudicialReviewCase_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "JudicialReviewImpact" (
    "id" TEXT NOT NULL,
    "caseId" TEXT NOT NULL,
    "articleNumber" TEXT NOT NULL,
    "articleId" TEXT,
    "disposition" "JudicialDisposition" NOT NULL,
    "effectiveDate" TIMESTAMP(3),
    "notes" TEXT,
    "amarExcerpt" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "JudicialReviewImpact_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "JudicialReviewCase_regulationId_idx" ON "JudicialReviewCase"("regulationId");

-- CreateIndex
CREATE INDEX "JudicialReviewCase_decisionDate_idx" ON "JudicialReviewCase"("decisionDate");

-- CreateIndex
CREATE UNIQUE INDEX "JudicialReviewCase_forum_decisionNumber_key" ON "JudicialReviewCase"("forum", "decisionNumber");

-- CreateIndex
CREATE INDEX "JudicialReviewImpact_caseId_idx" ON "JudicialReviewImpact"("caseId");

-- CreateIndex
CREATE INDEX "JudicialReviewImpact_articleNumber_idx" ON "JudicialReviewImpact"("articleNumber");

-- CreateIndex
CREATE INDEX "JudicialReviewImpact_articleId_idx" ON "JudicialReviewImpact"("articleId");
...
-- AddForeignKey
ALTER TABLE "JudicialReviewCase" ADD CONSTRAINT "JudicialReviewCase_regulationId_fkey" FOREIGN KEY ("regulationId") REFERENCES "Regulation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "JudicialReviewImpact" ADD CONSTRAINT "JudicialReviewImpact_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "JudicialReviewCase"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "JudicialReviewImpact" ADD CONSTRAINT "JudicialReviewImpact_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE SET NULL ON UPDATE CASCADE;
